<div>
	<div>
		...
		<ul>
			...
			<li>
				Created a pattern library of reusable and accessible UI components, defined styles and color
				palettes, and npm distribtion.
			</li>
			<li>
				Contributed to an existing pattern library and refactored an existing 250,000 line codebase
				to use each of the defined patterns.
			</li>
			<li>
		...
		<p>
			This project started as my first vue project and has gone through several iterations. It was
			converted from a code tutorial, to something customized to be my own, to its current iteration
			of vue 3 and vite, several css frameworks/libraries. If I need to test out some conversion for
			work I will usually do it here first as a test.
		</p>
		<a href="https://github.com/stephenstuder/Vue-todos" target="_blank" rel="noreferrer">
			<button>Code</button>
		</a>
		<a href="https://vue-todos-beta.vercel.app/" target="_blank" rel="noreferrer">
			<button>Site</button>
		</a>
	</div>
</div>
...
<div>
	...
	<a href="https://github.com/stephenstuder/fantasy-analysizer" target="_blank">
		<button>Code</button>
	</a>
...
<div>
	...
	<p>
		...
		interested but little-to-no experience in web development to landing a job as a full stack
		developer that he has been at for over a year now.
	</p>
</div>
